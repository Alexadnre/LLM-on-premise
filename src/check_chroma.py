...
# Charger la base
db = Chroma(persist_directory=CHROMA_PATH, embedding_function=OllamaEmbeddings(model=EMBEDDING_MODEL))
...
query = "Quels sont les niveau d'ans MAIA"  # Remplace par un mot-clé que tu penses présent
